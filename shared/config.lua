...
Config.Menu = 'ox_lib' -- ox_lib (Uncomment ox_lib export in fxmanifest.lua file) / qb / nh-context / esx_menu_default / esx_context - The menu system that you're using.
Config.MenuResource = 'ox_lib'

Config.Input = 'ox_lib' -- ox_lib (Uncomment ox_lib export in fxmanifest.lua file) / qb-input / nh-keyboard - The input system that you're using
Config.InputResource = 'ox_lib' -- The input system folder name that you're using

Config.TextUI = "ox_lib" -- ox-lib (Uncomment ox_lib export in fxmanifest.lua file) / qb - The TextUI system that you're using
Config.TextUIResource = "ox_lib" -- The TextUI system folder name that you're using

Config.Poly = "polyzone"
Config.PolyResource = "polyzone"

Config.Notifications = "ox_lib" -- ox_lib (Uncomment ox_lib export in fxmanifest.lua file) / qb / esx / okok / mythic - The notification system that your're using
