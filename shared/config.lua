...
Config.VehicleKeys = 'qb-vehiclekeys' -- MrNewbVehicleKeys / mk_vehiclekeys / okokGarage / qs-vehiclekeys / wasabi_carlock / cd_garage / t1ger_keys / F_RealCarKeysSystem / fivecode_carkeys / qb-vehiclekeys / stasiek_vehiclekeys / ti_vehicleKeys / vehicles_keys / xd_locksystem / -- The vehicle key system that you're using
...
Config.Clothing = 'qb-clothing' -- codem-appearance / tgiann-clothing / esx_skin / fivem-appearance / illenium-appearance / ox_appearance / qb-clothing